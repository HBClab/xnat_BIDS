...
# -*- coding: utf-8 -*-
#
# xnat_BIDS documentation build configuration file, created by
...
htmlhelp_basename = 'xnat_BIDSdoc'
...
latex_documents = [
  ('index', 'xnat_BIDS.tex', 'xnat_BIDS Documentation',
   'James Kent', 'manual'),
]
...
man_pages = [
    ('index', 'xnat_BIDS', 'xnat_BIDS Documentation',
     ['James Kent'], 1)
]
...
texinfo_documents = [
  ('index', 'xnat_BIDS', 'xnat_BIDS Documentation',
   'James Kent', 'xnat_BIDS', 'One line description of project.',
   'Miscellaneous'),
]
